...
BEGIN_MESSAGE_MAP(CBmpReadingView, CView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CBmpReadingView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()
...
void CBmpReadingView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
BOOL CBmpReadingView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// 기본적인 준비
	return DoPreparePrinting(pInfo);
}

void CBmpReadingView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: 인쇄하기 전에 추가 초기화 작업을 추가합니다.
}

void CBmpReadingView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
